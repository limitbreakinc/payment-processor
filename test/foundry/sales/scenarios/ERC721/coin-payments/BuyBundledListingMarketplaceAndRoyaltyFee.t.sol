...
contract BuyBundledListingMarketplaceAndRoyaltyFee is PaymentProcessorSaleScenarioBase {
...
collectionLevelOffer: false,
        ...
        assertEq(approvedPaymentCoin.balanceOf(sellerEOA), 0.85 ether * numItemsInBundle);
