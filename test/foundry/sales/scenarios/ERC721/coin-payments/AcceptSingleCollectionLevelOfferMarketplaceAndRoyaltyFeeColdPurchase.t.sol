...
contract AcceptSingleCollectionLevelOfferMarketplaceAndRoyaltyFeeColdPurchase is PaymentProcessorSaleScenarioBase {
    ...
    function test_executeSale() public {
        ...
        paymentProcessor.buySingleListing(
            ...
            _getSignedCollectionOffer(buyerKey, saleDetails));
